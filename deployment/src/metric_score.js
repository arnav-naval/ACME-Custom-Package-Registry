    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (url.includes("npmjs.com")) {
            try {
                ...
                if (!repo) {
                    yield info("No repository URL found in npm data");
                ...
                yield info("Error fetching npm data");
        ...
        try {
            ...
            yield info("Error fetching GitHub data");
        ...
        if (data.contributors_count || data.maintainers) {
            ...
            try {
                ...
                yield info("Error fetching contributors/maintainers");
                throw new Error("Error fetching contributors/maintainers");
            }
        }
        else {
            yield info("No contributor or maintainer data available");
        ...
        yield info(`Processed URL: ${url}, Score: ${netScore}`);
        yield info(`Result: ${JSON.stringify(result)}`);
        return result;
    });
}
// analyzes bus factor and returns M_b(r) as specified
// in project plan
export function busFactorScore(contributorsCount) {
    return __awaiter(this, void 0, void 0, function* () {
        let busFactorScore;
...
export function correctnessScore(IssueCount) {
    return __awaiter(this, void 0, void 0, function* () {
        if (IssueCount === undefined || IssueCount === null) {
            yield info("Issue count is missing, returning correctness score of 0");
...
export function pinnedDependenciesScore(repoUrl) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield info(`Error calculating pinned dependencies score: ${error.message}`);
...
export function pullRequestReviewScore(repoUrl) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield info(`Error in pullRequestReviewScore: ${error.message}`);
            return 0;
        }
    });
}
...
export function rampUpScore(repoUrl) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield info("Error fetching repository contents for ramp-up score");
...
export function responsivenessScore(openIssues, closedIssues) {
    return __awaiter(this, void 0, void 0, function* () {
...
export function licenseScore(data) {
    return __awaiter(this, void 0, void 0, function* () {
...
export function fetchCollaboratorsCount(url) {
    return __awaiter(this, void 0, void 0, function* () {
...
// Fetch repo contents
export function fetchRepoContents(url) {
    return __awaiter(this, void 0, void 0, function* () {
        const repoPath = url.split("github.com/")[1];
        if (!repoPath)
            throw new Error("Invalid GitHub URL");
